...
export const TwitterList = () => {
    ...
    return (
        <div>
            <div style={{ width: "100%",textAlign:"center" }}><h1>Twitter Twitt List</h1></div>

            <TextField placeholder='search....' onChange={searchUser}  sx={{marginRight:"10px"}}/>
            <TextField type="date" onChange={filterByDate} sx={{marginRight:"10px"}}/>
